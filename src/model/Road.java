...
public class Road implements Serializable {
	 ...
	 *            the road name
	 * @param startPoint
	 *            the road start point.
	 * @param finalPoint
	 *            the road final point.
	 * @param distance
	 *            the road length.
	 */
	public Road(String name, Point2D.Double startPoint,
			Point2D.Double finalPoint, double distance) {
		this.name = name;
	...
	@Override
	public int hashCode() {
		String str = distance + ";" + finalPoint.getX() + ","
				+ finalPoint.getY();
		return str.hashCode();
	}
	...
	public String toString() {
		...
		// return "Road [name = " + name + ", startPoint = " + startPoint.getX()
		// + "," + startPoint.getY()
		// + ", finalPoint = " + finalPoint.getX() + "," + finalPoint.getY() +
		// ", distance = " + distance
