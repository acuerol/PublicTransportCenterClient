...
public class Semaphore implements Serializable {
	 ...
	 *            the semaphore id.
	 * @param timeRed
	 *            the time until the red light change to green
	 * @param timeGreen
	 *            the time until the green light change to red
	 * @param position
	 *            the point associated to the node in the graph.
	 */
	public Semaphore(String id, int timeRed, int timeGreen,
	...
	/**
	 * Return the semaphore state, if the state is true the ligt is green else
	 * it is red.
	 * 
	...
	public String toString() {
		return id;
		// return "Semaphore [id = " + id + "]";//, children =
		// " + children + "]";

		// return "Semaphore [id = " + id + ", state = " + state +
