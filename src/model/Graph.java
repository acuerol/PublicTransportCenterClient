...
public class Graph implements Serializable {
	 ...
	 * 
	 * @param <E>
	 *            the type of ArrayList
	 * @param objects
	 *            the ArrayList<E> added to the graph.
	 */
	...
	/**
	 * Creates a bidirectional edge to the node represent by dataNodeA to the
	 * node represent by dataNodeB.
	 * 
	 * @param nodeA
	 ...
	 * 
	 * @param node
	 *            the node where will obtained the childNodes
	 * @return if the node is content in the graph nodes then return the node
	 *         childNodes, else return null.
	 */
